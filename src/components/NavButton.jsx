    ...
    if (highlight) {
        return (
            <motion.div variants={variants}>
                <button
                    onClick={onClick}
                    className="font-montserrat flex items-center gap-4 rounded-tl-full rounded-tr-lg hover:cursor-pointer rounded-br-full rounded-bl-full border-3 border-black bg-gradient-to-r from-green-500 to-lime-500 px-4 py-2 font-bold text-black hover:from-green-600 hover:to-lime-600 transition ease-in-out"
                >
                    {icon ? icon : ""}
                    {text}
                </button>
